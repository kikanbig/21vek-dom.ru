...
import HalvaPromo from "./pages/promos/HalvaPromo";
      ...
      <BrowserRouter>
        ...
        <Suspense fallback={<PageLoader />}>
          <Routes>
            ...
            <Route path="/promos/halva" element={<HalvaPromo />} />
            <Route path="/promos/space" element={<Navigate to="/promos/halva" replace />} />

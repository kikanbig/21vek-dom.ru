...
const SUBCATEGORY_NAMES: Record<string, string> = {
  ...
  decor: 'Декор и зеркала', mugs: 'Кружки и чайники', blankets: 'Пледы и покрывала',
  pillows: 'Подушки и одеяла', towels: 'Полотенца', bedlinen: 'Постельное белье',
  cookware: 'Посуда для готовки', glasses: 'Кружки, стаканы, бокалы',
  cutlery: 'Столовые приборы', plates: 'Тарелки и блюда', other: 'Другое',
  'ortho-pillows': 'Ортопедические подушки',
  bedsets: 'Комплекты постельного белья', sheets: 'Простыни',
  'duvet-covers': 'Пододеяльники', pillowcases: 'Наволочки',
  baths: 'Санфаянс и аксессуары', sinks: 'Мойки и раковины', faucets: 'Смесители и души',
